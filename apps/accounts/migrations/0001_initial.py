...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_userprofile', (
            ...
            ('jid', self.gf('django.db.models.fields.CharField')(max_length=254, blank=True)),
            ('skype_id', self.gf('django.db.models.fields.CharField')(max_length=254, blank=True)),
            ('other_contacts', self.gf('django.db.models.fields.TextField')(max_length=1000, blank=True)),
        ))
        db.send_create_signal(u'accounts', ['UserProfile'])

        # Adding M2M table for field groups on 'UserProfile'
        m2m_table_name = db.shorten_name(u'accounts_userprofile_groups')
        ...
        m2m_table_name = db.shorten_name(u'accounts_userprofile_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'accounts.userprofile'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'accounts_userprofile_groups'))

        # Removing M2M table for field user_permissions on 'UserProfile'
        db.delete_table(db.shorten_name(u'accounts_userprofile_user_permissions'))
    ...
    models = {
        u'accounts.userprofile': {
            ...
            'jid': ('django.db.models.fields.CharField', [], {'max_length': '254', 'blank': 'True'}),
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'other_contacts': ('django.db.models.fields.TextField', [], {'max_length': '1000', 'blank': 'True'}),
            'password': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'skype_id': ('django.db.models.fields.CharField', [], {'max_length': '254', 'blank': 'True'}),
